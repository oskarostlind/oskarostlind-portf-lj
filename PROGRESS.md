...
- **Bilder:** `public/case/` är tom. Pipelinen är byggd och testad, så det enda som fattas är filerna: lägg en bild per case i `public/case/` döpt till casets slug (`avyracards.webp`, `nextwatch.webp`, …), minst 1600 px bred. Nästa bygge plockar upp dem automatiskt. Tills dess renderas gradienterna. Se avsnittet "Bilder" i README.
